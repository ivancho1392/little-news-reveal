...
export function WelcomeScreen({ onStart }: Props) {
  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-between overflow-hidden px-7 py-12">
      ...
      <div className="mt-10 flex flex-col items-center gap-2 text-center animate-text-rise">
        <span className="text-[10px] font-medium uppercase tracking-[0.4em] text-foreground/55">
      ...
      <div className="flex flex-col items-center gap-3 text-center">
        <h1
          className="font-serif-display text-[2rem] leading-[1.15] text-foreground animate-text-rise"
          style={{ animationDelay: "0.2s" }}
        >
          Tenemos algo<br />muy especial para ti…
        </h1>
        <p
          className="mt-3 max-w-xs text-sm text-foreground/65 animate-text-rise"
      ...
      <div
        className="flex w-full flex-col gap-2.5 animate-text-rise"
      ...
      >
        ...
        <button
          ...
          className={`mt-5 w-full rounded-full px-6 py-4 font-serif-display text-lg tracking-wide transition-all duration-500 ${
            selected
